...
return [
    ...
    */
    ...
    'button_text' => [
        'confirm' => env('SWEET_ALERT_CONFIRM_BUTTON_TEXT', 'تایید'),
        'cancel' => env('SWEET_ALERT_CANCEL_BUTTON_TEXT', 'لغو'),
    ],
    ...
    */
    ...
    'confirm_delete_confirm_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_TEXT', 'تایید'),
