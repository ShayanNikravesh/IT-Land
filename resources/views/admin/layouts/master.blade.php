...
<html lang="fa" direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<head><base href="">
		...
		<!--end::Layout Themes-->
		<link rel="shortcut icon" href="{{asset('admin-ssets/media/logos/favicon.ico')}}a" />
	</head>
	<!--end::Head-->
	<!--begin::Body-->
					...
					<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Shayan Nik</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Nav-->
