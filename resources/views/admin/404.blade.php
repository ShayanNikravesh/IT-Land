...
<html lang="fa" direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Error-->
			<div class="d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url('{{asset('admin-assets/media/error/bg2.jpg')}}');">
				<!--begin::Content-->
				<div class="d-flex flex-row-fluid flex-column justify-content-end align-items-center text-center text-white pb-40">
					<h1 class="display-1 font-weight-bold">خطا!</h1>
					<span class="display-4 font-weight-boldest mb-8">صفحه مورد نظر یافت نشد.</span>
				</div>
				<!--end::Content-->
			</div>
			<!--end::Error-->
