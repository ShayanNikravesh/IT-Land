		...
		<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
			<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
				...
				<div class="d-flex align-items-center flex-wrap mr-2">
					<!--begin::Page Title-->
					<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">لیست برند ها</h5>
					<!--end::Page Title-->
					<!--begin::Actions-->
					<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-4 bg-gray-200"></div>
					<span class="font-weight-bold mr-4">در این صفحه لیست برند ها را مشاهده میکنید.</span>
					<!--end::Actions-->
				</div>
				<!--end::Info-->
				<!--begin::Toolbar-->
		...
		<div class="card card-custom">
			<div class="card-header">
				<div class="card-title">
					...
					<h3 class="card-label font-weight">لیست برند ها</h3>
				</div>
			</div>
			<div class="card-body">
				<!--begin: Datatable-->
								...
								<tr>
									...
									<td>
										<div class="d-flex">
											...
											<a href="{{route('brand.destroy',$brand->id)}}" method="POST" data-toggle="tooltip" data-placement="bottom" title="حذف برند " data-confirm-delete="true">
