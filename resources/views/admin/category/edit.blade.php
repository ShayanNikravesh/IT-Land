    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                ...
                <div class="card-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{route('category.update',$category)}}" id="kt_form">
                        @csrf
						@method('PUT')
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-5">
                                            <input class="form-control form-control-solid" type="text" name="title" value="{{$category->title}}" />
                                        </div>
                                        <label class="">عنوان انگلیسی :</label>
                                        <div class="col-5">
                                            <input class="form-control form-control-solid" type="text" name="english_title" value="{{$category->english_title}}" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-6">
                                            <select class="form-control form-control-solid" type="text" name="parent_id">
												...
												<option {{$parentcategory->id == $category->parent_id ? 'selected' : ''}} value="{{$parentcategory->id}}">{{$parentcategory->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
