								...
								<tr>
									...
									<td>
										<div class="d-flex">
											...
											<a href="{{route('comment.show',$product->id)}}" class="btn-sm btn-warning btn mx-1" data-toggle="tooltip" data-placement="top" title="مدیریت نظرات">
									...
									<td>
										<div class="d-flex">
											<div class="dropdown" id="div{{$product->id}}">
												...
												<div class="dropdown-menu bg-dark" style="z-index: 200" aria-labelledby="ChangeStatusProduct">
