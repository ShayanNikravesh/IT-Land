        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 d-flex justify-content-around align-items-center mb-3">
                ...
                <div class="story-item">
                    <img src="{{asset('user-assets/img/story-1.jpg')}}" alt="" class="img-fluid border-radius-circle"
                ...
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story1">
                    <img src="{{asset('user-assets/img/story-2.jpg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
                ...
                <!--                Story Item:start-->
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story1">
                    <img src="{{asset('user-assets/img/story-3.jpg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
                ...
                <!--                Story Item:start-->
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story1">
                    <img src="{{asset('user-assets/img/story-4.jpeg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 d-flex justify-content-around align-items-center mb-3">
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story5">
                    <img src="{{asset('user-assets/img/story-5.jpeg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
                    <strong class="fs-7">وقت سفر</strong>
                </div>
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story6">
                    <img src="{{asset('user-assets/img/story-7.jpeg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
                    <strong class="fs-7">پیراهن</strong>
                </div>
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story7">
                    <img src="{{asset('user-assets/img/story-8.jpeg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
                    <strong class="fs-7">آرایش صورت</strong>
                </div>
                <div class="story-item" data-bs-toggle="modal" data-bs-target="#story8">
                    <img src="{{asset('user-assets/img/story-6.jpeg')}}" alt="" class="img-fluid border-radius-circle"
                         data-bs-toggle="modal" data-bs-target="#storyBanners">
                    ...
                    <div class="swiper storySlider w-100 position-relative">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-assets/img/story-banner-2.jpeg')}}" alt=""/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-assets/img/story-banner-3.jpeg')}}" alt=""/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-assets/img/story-banner-4.jpeg')}}" alt=""/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-assets/img/story-banner-5.jpeg')}}" alt=""/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-assets/img/story-banner-6.jpg')}}" alt=""/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-assets/img/story-banner-7.jpg')}}" alt=""/></a>
                            </div>
                            <div class="swiper-slide">
                                <a href="" title=""><img src="{{asset('user-ssets/img/story-banner-8.jpg')}}a" alt=""/></a>
                            </div>
                        </div>
        ...
        <div class="wrapper mt-4 border-radius-3xl border border-gray-300 overflow-hidden">
            ...
            <div class="row">
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-1.jpg')}}" alt="" title="" class="img-fluid p-1">
                ...
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-2.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-3.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-4.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-5.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-6.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-7.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-8.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-9.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-10.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-11.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
                <div class="suggest-item col-6 col-md-4 col-lg-2 col-xl-2">
                    <div class="p-3">
                        <a href="" title="" class="stretched-link">
                            <img src="{{asset('user-assets/img/suggest-12.jpg')}}" alt="" title="" class="img-fluid p-1">
                            <h4 class="mt-3 fs-7">گوشی</h4>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                <div class="some-products-box p-4">
                    ...
                    <div class="some-products-images mt-3">
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-1.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-2.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-3.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-4.jpg')}}" alt="" title="" class="img-fluid"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                <div class="some-products-box p-4">
                    ...
                    <div class="some-products-images mt-3">
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-5.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-6.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-7.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-8.jpg')}}" alt="" title="" class="img-fluid"></a>
                    </div>
                </div>
            </div>
            <!--            Some Products Item:end-->
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                <div class="some-products-box p-4">
                    ...
                    <div class="some-products-images mt-3">
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-9.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-10.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-11.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-12.jpg')}}" alt="" title="" class="img-fluid"></a>
                    </div>
                </div>
            </div>
            <!--            Some Products Item:end-->
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
                <div class="some-products-box p-4">
                    ...
                    <div class="some-products-images mt-3">
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-13.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-14.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-15.jpg')}}" alt="" title="" class="img-fluid"></a>
                        <a href="" title="" class="d-flex justify-content-center align-items-center p-3"><img src="{{asset('user-assets/img/some-p-16.jpg')}}" alt="" title="" class="img-fluid"></a>
                    </div>
                </div>
            </div>
            <!--            Some Products Item:end-->
            ...
            <div class="swiper-wrapper">
                    ...
                    <div class="best-sale-item">
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-1.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-2.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-3.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                ...
                <div class="swiper-slide">
                    <div class="best-sale-item">
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-4.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">1</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-5.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">2</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-6.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">3</span>
                ...
                <div class="swiper-slide">
                    <div class="best-sale-item">
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-7.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">1</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-8.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">2</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-9.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">3</span>
                ...
                <div class="swiper-slide">
                    <div class="best-sale-item">
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-10.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">1</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-11.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">2</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-12.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">3</span>
                ...
                <div class="swiper-slide">
                    <div class="best-sale-item">
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-13.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">1</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-14.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">2</span>
                        ...
                        <a href="" title=""
                           class="stretched-link d-flex justify-content-around align-items-center mb-2">
                            <img src="{{asset('user-assets/img/some-p-15.jpg')}}" alt="" title="" class="img-fluid p-3 object-contain">
                            <span class="text-info fs-3 fw-bold">3</span>
