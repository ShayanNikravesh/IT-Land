...
<head>
    ...
    <!--    Bootstrap 5 RTL-->
    <link rel="stylesheet" href="assets/css/vendors/bootstrap/bootstrap.rtl.css">
    <!--    Fontawesome 5-->
    <link rel="stylesheet" href="assets/css/vendors/fontawesome/fontawesome.min.css">
    <!--    SwiperJs Styles-->
                ...
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="top-mobile-navbar-middle d-flex justify-content-between align-items-center">
                        ...
                        <a href="javascript:void(0)" class="navbar-brand">
                            <img src="assets/img/logo.png" alt="لوگوی برگ شاپ" class="blur-up">
                        </a>
                        <!--            Logo:end-->
                    </div>
        ...
        <div class="top-navbar navbar-expand-lg navbar-light py-2">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="top-nav-right d-flex justify-content-between align-items-center">
                    <!--            Logo:start-->
                    <a href="javascript:void(0)" class="navbar-brand">
                        <img src="assets/img/logo-md.png" alt="لوگوی برگ شاپ" class="blur-up">
                    </a>
                    <!--            Logo:end-->
...
<main class="container">
    <div class="payment">
        ...
        <div class="payment-header border-radius-xl my-3">
            ...
            <a href=""><img src="assets/img/logo.png" alt="" class="payment-img d-block mx-auto my-3"></a>
        ...
        <div class="payment-details cart">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-9">
                            ...
                            <form action="">
                                <div class="mb-4 border-bottom-gray-150 pb-3">
                                    ...
                                    <label class="form-check-label fw-bold" for="wallet">
                                        ...
                                        کیف پول
                                        <span class="d-block mt-2 ms-5"><span class="fs-7 fw-lighter">موجودی</span> 100,000 تومان</span>
                                    </label>
                                </div>

                                <div class="mb-4 border-bottom-gray-150 pb-3">
                                    <input class="form-check-input" type="radio" name="payMethod" id="netPurchase">
                                    <label class="form-check-label fw-bold" for="netPurchase">
                                        <i class="fa fa-credit-card fs-3 px-2 gray-500"></i>
                                        کیف پول
                                        <span class="d-block mt-2 ms-5"><span class="fs-7 fw-lighter">موجودی</span> 100,000 تومان</span>
                                    </label>
                                </div>
                    ...
                    <!--                    Payment Discount Code:start-->
                    <div class="payment-discount border border-radius-xl p-3 mb-3">
                        <h2 class="fs-5 fw-bold">کد تخفیف</h2>
                        <div class="payment-methods mt-4">
                            <form action="" class="position-relative">
                                <input type="text" class="form-control py-2 border-radius-xl" placeholder="اگر کد تخفیف دارید وارد کنید ...">
                                <button type="submit" class="btn position-absolute fs-7">ثبت</button>
                            </form>
                        </div>
                    </div>
                    <!--                    Payment Discount Code:end-->

                    <!--                    Payment Gift Code:start-->
                    <div class="payment-discount border border-radius-xl p-3 mb-3">
                        <h2 class="fs-5 fw-bold">کد هدیه</h2>
                        <div class="payment-methods mt-4">
                            <form action="" class="position-relative">
                                <input type="text" class="form-control py-2 border-radius-xl" placeholder="اگر کد هدیه دارید وارد کنید ...">
                                <button type="submit" class="btn position-absolute fs-7">ثبت</button>
                            </form>
                        </div>
                    </div>
                    <!--                    Payment Gift Code:end-->
                ...
                <div class="col-sm-12 col-md-12 col-lg-4 col-xl-3 mt-3">
                    <div class="cart-cal border border-radius-xl overflow-hidden">
                        ...
                        <div class="product-score d-flex justify-content-between align-items-center bg-gray-200 p-3">
                            <div>
                                <img src="assets/img/club-point.svg" alt="">
