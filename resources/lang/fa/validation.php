...
return [
    ...
    'attributes' => [
        ...
        'color.*' => 'رنگ',
        'color_stock.*' => 'تعداد رنگ',
        'color_price.*' => 'قیمت رنگ',
        'color_price_discounted.*' => 'قیمت با تخفیف رنگ',
        'new_color.*' => 'رنگ جدید',
        'new_color_stock.*' => 'تعداد رنگ جدید',
        'new_color_price.*' => 'قیمت رنگ جدید',
        'new_color_price_discounted.*' => 'قیمت با نخفیف رنگ جدید',
        'comment' => 'متن',
    ]
];
